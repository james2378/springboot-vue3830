...
const routes = [
	...
	// 职位信息路由
	{
		path: '/position_information/table',
		name: 'position_information_table',
		component: () => import('../views/position_information/table.vue')
	},
	{
		path: '/position_information/view',
		name: 'position_information_view',
		component: () => import('../views/position_information/view.vue')
	},
